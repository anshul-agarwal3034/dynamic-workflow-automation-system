        ...
        <div className="w-full max-w-[440px] bg-white rounded-[12px] border border-slate-200 shadow-[0_10px_25px_-5px_rgba(0,0,0,0.05)] p-8 sm:p-10 my-auto overflow-visible shrink-0">
          ...
          {currentView === 'signup' && (
            <div>
              ...
              <div className="mt-6 text-center text-xs text-slate-600">
                ...
                <button onClick={() => setCurrentView('signin')} className="text-blue-600 font-semibold hover:underline">
                  Sign In
                </button>
              </div>
            </div>
            ...
            <div>
              ...
              {showErrorBanner && (
                <div className="mb-4 p-3 rounded-lg bg-red-50 border border-red-200 flex items-center justify-between text-xs text-red-700">
                  ...
                  <button onClick={() => setShowErrorBanner(false)} className="text-red-500 font-bold">×</button>
                </div>
              )}
              ...
              <div className="mt-4 text-center">
                ...
                >
                  {showErrorBanner ? "Hide Demo Error Banner" : "Simulate Invalid Login Error"}
                </button>
              </div>
          ...
          {currentView === 'forgot-email' && (
            <div>
              ...
              <div className="mt-6 text-center text-xs">
                <button onClick={() => setCurrentView('signin')} className="text-slate-500 hover:text-slate-800 font-medium">
                  ← Back to Sign In
                </button>
              </div>
            </div>
          ...
          {currentView === 'forgot-reset' && (
            <div>
              ...
              <form className="space-y-4" onSubmit={(e) => { e.preventDefault(); setCurrentView('signin'); }}>
                <div>
